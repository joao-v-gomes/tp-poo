...
class SistemaCompAerea
{
    static function sis_CadastrarCompanhiaAerea()
    {
    ...
    static function sis_verCompanhiasAereas()
    {
    ...
    static function mostraCompanhiasAereas(array $companhiasAereas)
    {
    ...
    static function sis_editarCompanhiaAerea()
    {
        $companhiasAereas = CompanhiaAerea::getRecords();
    ...
    static function sis_conectarAeronaveEmCompanhiaAerea()
    {
    ...
    static function sis_verAeronavesDaCompanhiaAerea()
    {
        $companhiasAereas = CompanhiaAerea::getRecords();
    ...
    static function sis_conectarVeiculoEmCompanhiaAerea()
    {
    ...
    static function sis_verVeiculosDaCompanhiaAerea()
    {
        $companhiasAereas = CompanhiaAerea::getRecords();
    ...
    static function sis_verPilotosDaCompanhiaAerea()
    {
        $companhiasAereas = CompanhiaAerea::getRecords();
    ...
    static function sis_verComissariosDaCompanhiaAerea()
    {
        $companhiasAereas = CompanhiaAerea::getRecords();
    ...
    static function sis_cadastrarProgramaDeMilhagem()
    {
    ...
    static function sis_verProgramasDeMilhagem()
    {
    ...
    static function mostraProgramasDeMilhagem(array $programasDeMilhagem)
    {
    ...
    static function sis_editarProgramaDeMilhagem()
    {
        $programasDeMilhagem = ProgramaMilhagem::getRecords();
    ...
    static function sis_verProgramaDeMilhagemDaCompanhiaAerea()
    {
        $companhiasAereas = CompanhiaAerea::getRecords();
    ...
    static function sis_cadastrarCategoriaNoProgramaDeMilhagem()
    {
        $programasDeMilhagem = ProgramaMilhagem::getRecords();
    ...
    static function sis_verCategoriasNoProgramaDeMilhagem()
    {
        $programasDeMilhagem = ProgramaMilhagem::getRecords();
    ...
    static function mostraCategoriasProgramaMilhagem(array $categorias)
    {
    ...
    static function sis_editarCategoriaNoProgramaDeMilhagem()
    {
        $programasDeMilhagem = ProgramaMilhagem::getRecords();
