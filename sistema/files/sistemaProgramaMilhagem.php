...
class SistemaProgramaMilhagem
{
    ...
    static function sis_verProgramasDeMilhagem()
    {
        ...
        SistemaProgramaMilhagem::mostraProgramasDeMilhagem($programasDeMilhagem);
    ...
    static function sis_verCategoriasNoProgramaDeMilhagem()
    {
        ...
        SistemaProgramaMilhagem::mostraCategoriasProgramaMilhagem($categorias);
